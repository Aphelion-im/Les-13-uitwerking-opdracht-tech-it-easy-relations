...
VALUES
  (1001, 'NH3216SMART', 'Nikkei', 'HD smart TV', 159, 32, 100, 'LED', 'HD ready',  true, true, false, false, false, false, 235885, 45896),
  ...
  (1006, 'OLED55C16LA', 'Samsung', 'LG OLED55C16LA', 989, 55, 100, 'OLED', 'ULTRA HD',  true, true, true, true, true, false, 50000, 20500);

-- Een ManyToMany relatie tussen Television en WallBracket, koppeltabel
INSERT INTO televisions_wall_brackets (television_id, wall_bracket_id) values (1005, 1001),
 (1005, 1002),
 (1002, 1003),
 (1003, 1003),
 (1004, 1003),
